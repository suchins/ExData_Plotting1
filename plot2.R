...
#open png device
png(file="C:\\Course4\\Week1\\plot2.png",width = 480, height = 480)
#write the scatter plot
with(xfilter,plot(as.POSIXct(paste(Date,Time),"%d/%m/%Y"),Global_active_power,xlab="",ylab="Global Active Power",type="l"))
dev.off()
